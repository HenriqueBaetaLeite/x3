    ...
    <div className="min-h-screen bg-black text-white p-6 sm:p-20 font-[family-name:var(--font-geist-sans)] flex flex-col items-center justify-between gap-16">
      <div className="max-w-3xl mx-auto my-8 p-6 bg-black rounded-lg shadow-lg shadow-gray-800/50">
        ...
        <ol className="list-decimal pl-6 space-y-4 text-white mb-5">
          <li>
            Serão{" "}
            <span className="font-semibold text-blue-400">3 jogadores</span> em
            cada equipe.
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-300">
              <li>
                ...
                como neutra (como a bandeirinha de escanteio no futebol), e a
                bola continua em jogo.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-300">
              <li>
                Tanto{" "}
                <span className="font-semibold text-blue-400">chapéu</span>{" "}
                quanto{" "}
                <span className="font-semibold text-blue-400">caneta</span>, se
                validados pela arbitragem, contam como gol.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-300">
              ...
              <li>
                O restante dos jogadores deve ficar atrás da linha da bola.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            Cada equipe tem direito a acionar 1 vez o x1, em qualquer momento do
            jogo, que consiste em:
            <ul className="list-disc pl-6 mt-2 space-y-1 text-gray-300">
              <li>
                Duelo de 1 jogador contra 1 adversário (a escolha de cada
                equipe).
              </li>
              <li>
