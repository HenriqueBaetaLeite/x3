      ...
      >
        ...
        <div className="text-gray-300 space-y-5 text-lg leading-relaxed">
          ...
          <p className="flex items-start gap-2 text-yellow-400">
            <AlertCircle size={22} />
            <span>
              <strong>ATENÇÃO:</strong> Apenas um dos integrantes de cada equipe
              deve realizar a inscrição.
            </span>
          </p>

          <p>
            📋 Basta acessar o link abaixo e preencher{" "}
            <span className="text-blue-400 font-semibold">todos os campos</span>{" "}
            do formulário.
          </p>
          ...
          <p>
            📱 Caso tenha dúvidas, entre em contato com a organização do
            torneio.
          </p>
        </div>
